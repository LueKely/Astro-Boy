...
describe("Read And Write in BC Register", () => {
  test("Should Get BC", () => {
    Register.register.B.setRegister(0b0001);
    Register.register.C.setRegister(0b0001);
  ...
  test("Set BC value to 69 Excpect B to be 0 & C to be 69", () => {
    ...
    expect(Register.register.B.getRegister()).toBe(0);
    expect(Register.register.C.getRegister()).toBe(69);
  });
